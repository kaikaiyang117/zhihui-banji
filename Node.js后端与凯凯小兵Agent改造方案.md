...
> 当前阶段：MIG-00 至 MIG-06 已完成；下一步 MIG-07 高频教师业务（考勤、成绩、任务、值日、校历）。不授权删除 Python 后端、修改真实数据库、提交、推送或发布
...
| 7 | `MIG-07` 高频教师业务 | 考勤、成绩、任务、值日、校历 | ⬜ 待开始 |
| 8 | `MIG-08` 账目与教育沉淀 | 积分、班费、评语、教育记录、知识库 | ⬜ 待开始 |
